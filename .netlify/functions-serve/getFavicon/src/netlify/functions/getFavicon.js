...
var require_debug = __commonJS({
  "node_modules/axios/node_modules/debug/src/debug.js"(exports2, module2) {
      ...
      Object.keys(protocols).forEach(function(scheme) {
        ...
        wrappedProtocol.request = function(options, callback) {
          if (typeof options === "string") {
            ...
            options.maxRedirects = exports3.maxRedirects;
          } else {
...
// node_modules/get-website-favicon/lib/request.js
var require_request = __commonJS({
  "node_modules/get-website-favicon/lib/request.js"(exports2, module2) {
    "use strict";
    var axios = require_axios2().create({
      headers: {
    ...
    module2.exports = async (url, options = {}) => {
      options.url = url;
...
// node_modules/get-website-favicon/lib/getdom.js
var require_getdom = __commonJS({
  "node_modules/get-website-favicon/lib/getdom.js"(exports2, module2) {
    "use strict";
    var request = require_request();
    var cheerio = require_lib13();
    var { parse: urlParse } = require("url");
    module2.exports = async (url) => {
      return new Promise(async (resolve, reject) => {
        try {
          let response = await request(url), html = response.data, $ = cheerio.load(html, {
            lowerCaseTags: true,
...
// node_modules/get-website-favicon/lib/rank.js
var require_rank = __commonJS({
  "node_modules/get-website-favicon/lib/rank.js"(exports2, module2) {
    "use strict";
    var orders = [{
      key: "origin",
      rank: (item) => {
...
// node_modules/get-website-favicon/lib/origin/file.js
var require_file = __commonJS({
  "node_modules/get-website-favicon/lib/origin/file.js"(exports2, module2) {
    "use strict";
    var request = require_request();
    var { URL, parse: urlParse } = require("url");
    var fileType = require_file_type();
    module2.exports = async (baseurl) => {
      let icons = [];
      return new Promise(async (resolve, reject) => {
...
// node_modules/get-website-favicon/lib/origin/html.js
var require_html2 = __commonJS({
  "node_modules/get-website-favicon/lib/origin/html.js"(exports2, module2) {
    "use strict";
    var { URL, parse: urlParse } = require("url");
    var cheerio = require_lib13();
    var selectors = [
...
// node_modules/get-website-favicon/lib/origin/manifest.js
var require_manifest = __commonJS({
  "node_modules/get-website-favicon/lib/origin/manifest.js"(exports2, module2) {
    "use strict";
    var request = require_request();
    var { URL, parse: urlParse } = require("url");
    module2.exports = async ($) => {
      ...
      return new Promise(async (resolve, reject) => {
        ...
        try {
          ...
          if (response.status == 200 && response.data && Array.isArray(response.data.icons)) {
            icons = response.data.icons.map(({ src = "", sizes = "", type = "" }) => ({ src: new URL(src, url).href, sizes, type, origin: url })) || [];
          }
        } catch (error) {
        }
        resolve(icons);
...
// node_modules/get-website-favicon/lib/origin/deep.js
var require_deep = __commonJS({
  "node_modules/get-website-favicon/lib/origin/deep.js"(exports2, module2) {
    "use strict";
    module2.exports = async (url) => {
      let icons = [];
      return new Promise(async (resolve, reject) => {
...
// node_modules/get-website-favicon/lib/index.js
var require_lib14 = __commonJS({
  "node_modules/get-website-favicon/lib/index.js"(exports2, module2) {
    "use strict";
    var { URL, parse: urlParse } = require("url");
    var getdom = require_getdom();
    var rank = require_rank();
    var iconByFile = require_file();
    var iconByHtml = require_html2();
    var iconByManifest = require_manifest();
    var iconByDeep = require_deep();
    module2.exports = async (url) => {
      let icons = [];
      return new Promise(async (resolve, reject) => {
        if (!url)
        ...
        if (!urlParse(url).protocol)
          url = `http://${url}`;
        let $ = await getdom(url), tagIcon = await iconByHtml($), manifestIcon = await iconByManifest($), fileIcon = await iconByFile($.baseUrl), deepIcon = await iconByDeep(url);
...
// node_modules/get-website-favicon/index.js
var require_get_website_favicon = __commonJS({
  "node_modules/get-website-favicon/index.js"(exports2, module2) {
    "use strict";
    var getWebsiteFavicon = require_lib14();
    module2.exports = async (url, options) => {
...
// helpers/getFavicon.js
var import_get_website_favicon = __toModule(require_get_website_favicon());
async function getFavicon_default(url) {
  const faviconData = await (0, import_get_website_favicon.default)(url);
...
// netlify/functions/getFavicon.js
...
exports.handler = async function({ queryStringParameters }, context) {
  try {
    ...
    if (!url)
      return { statusCode: 400, body: "Url parameter not provided" };
    if (!validURL(url))
      return { statusCode: 400, body: "Invalid Url" };
    const favicon = await getFavicon_default(url);
    return {
      statusCode: 200,
